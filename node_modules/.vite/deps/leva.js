...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props3) => {
      ...
      return (0, import_jsx_runtime.jsx)(Context3.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      var _a;
      const Context3 = ((_a = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a[index2]) || BaseContext;
      const context = React2.useContext(Context3);
...
var Slot = React3.forwardRef((props3, forwardedRef) => {
  const { children, ...slotProps } = props3;
...
var SlotClone = React3.forwardRef((props3, forwardedRef) => {
  const { children, ...slotProps } = props3;
...
var Primitive = NODES.reduce((primitive, node) => {
  const Node2 = React4.forwardRef((props3, forwardedRef) => {
    const { asChild, ...primitiveProps } = props3;
...
var DismissableLayerBranch = React7.forwardRef((props3, forwardedRef) => {
  const context = React7.useContext(DismissableLayerContext);
...
var NAME = "Arrow";
var Arrow = React11.forwardRef((props3, forwardedRef) => {
...
var PopperArrow = React13.forwardRef(function PopperArrow2(props3, forwardedRef) {
...
var Portal = React14.forwardRef((props3, forwardedRef) => {
  var _a;
  ...
  return container ? import_react_dom4.default.createPortal((0, import_jsx_runtime7.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var PanelSettingsContext = (0, import_react7.createContext)(null);
function useStoreContext() {
  return (0, import_react7.useContext)(StoreContext);
}
function usePanelSettingsContext() {
  return (0, import_react7.useContext)(PanelSettingsContext);
}
function LevaStoreProvider({
  children,
  store
}) {
  return import_react7.default.createElement(StoreContext.Provider, {
    value: store
  }, children);
}
var getDefaultTheme = () => ({
...
function ValueInput(_ref) {
  ...
  const update = (0, import_react7.useCallback)((fn) => (event) => {
  ...
  const onKeyPress = (0, import_react7.useCallback)((event) => {
    if (event.key === "Enter") {
  ...
  return import_react7.default.createElement(InputContainer, {
    textArea: isTextArea
  }, innerLabel && typeof innerLabel === "string" ? import_react7.default.createElement(InnerLabel, null, innerLabel) : innerLabel, import_react7.default.createElement(StyledInput, _extends2({
    levaType: type,
    ref: inputRef,
    id: inputId,
    type: inputType,
...
function NumberInput(_ref2) {
  ...
  const _onUpdate = (0, import_react7.useCallback)((v4) => onUpdate(parseNumber(v4)), [onUpdate]);
  ...
  return import_react7.default.createElement(ValueInput, _extends2({}, props3, {
    onUpdate: _onUpdate,
    onKeyDown,
    type: "number"
  }));
...
function Portal2({
  ...
  return import_react7.default.createElement($f1701beae083dbae$export$be92b6f5f03c0fe9, {
    className
  }, children);
}
...
function OptionalToggle() {
  ...
  return import_react7.default.createElement(import_react7.default.Fragment, null, import_react7.default.createElement(StyledOptionalToggle, {
    id: id + "__disable",
    type: "checkbox",
    checked: !disabled,
...
function RawLabel(props3) {
  ...
  return import_react7.default.createElement(import_react7.default.Fragment, null, optional2 && import_react7.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react7.default.createElement(Root32, null, import_react7.default.createElement(Trigger, {
    asChild: true
  }, import_react7.default.createElement(StyledLabel, _extends2({}, htmlFor, props3))), import_react7.default.createElement(Content2, {
    side: "top",
    sideOffset: 2
  }, import_react7.default.createElement(StyledToolTipContent, null, hint, import_react7.default.createElement(ToolTipArrow, null)))) : import_react7.default.createElement(StyledLabel, _extends2({}, htmlFor, title, props3)));
}
function Label(_ref) {
  let {
    align
  ...
  return import_react7.default.createElement(CopyLabelContainer, {
    align,
    onPointerLeave: () => setCopied(false)
  }, import_react7.default.createElement(RawLabel, props3), copyEnabled && !disabled && import_react7.default.createElement("div", {
    title: `Click to copy ${typeof label === "string" ? label : key} value`
  }, !copied ? import_react7.default.createElement("svg", {
    onClick: handleClick,
...
function Chevron(_ref) {
  ...
  return import_react7.default.createElement(Svg, _extends2({
    width: "9",
    height: "5",
    viewBox: "0 0 9 5",
    xmlns: "http://www.w3.org/2000/svg",
  ...
  }, props3), import_react7.default.createElement("path", {
...
function Row(_ref) {
  ...
  if (input) return import_react7.default.createElement(StyledInputRow, props3);
  return import_react7.default.createElement(StyledRow, props3);
}
function useInputSetters({
  ...
  const [displayValue, setDisplayValue] = (0, import_react7.useState)(format$2(type, value, settings));
  const previousValueRef = (0, import_react7.useRef)(value);
  const settingsRef = (0, import_react7.useRef)(settings);
  settingsRef.current = settings;
  const setFormat = (0, import_react7.useCallback)((v4) => setDisplayValue(format$2(type, v4, settingsRef.current)), [type]);
  const onUpdate = (0, import_react7.useCallback)((updatedValue) => {
    try {
...
function useCanvas2d(fn) {
  const canvas = (0, import_react7.useRef)(null);
  const ctx = (0, import_react7.useRef)(null);
  const hasFired = (0, import_react7.useRef)(false);
  (0, import_react7.useEffect)(() => {
...
function useTransform() {
  ...
  const local = (0, import_react7.useRef)({
    x: 0,
    y: 0
  });
  const set = (0, import_react7.useCallback)((point) => {
...
function useInput(path) {
  ...
  const [state, setState] = (0, import_react7.useState)(getInputAtPath(store.getData(), path));
  const set = (0, import_react7.useCallback)((value) => store.setValueAtPath(path, value, true), [path, store]);
  const setSettings = (0, import_react7.useCallback)((settings) => store.setSettingsAtPath(path, settings), [path, store]);
  const disable = (0, import_react7.useCallback)((flag) => store.disableInputAtPath(path, flag), [path, store]);
  const emitOnEditStart = (0, import_react7.useCallback)(() => store.emitOnEditStart(path), [path, store]);
  const emitOnEditEnd = (0, import_react7.useCallback)(() => store.emitOnEditEnd(path), [path, store]);
  (0, import_react7.useEffect)(() => {
...
function RangeSlider({
  ...
  const ref = (0, import_react7.useRef)(null);
  const scrubberRef = (0, import_react7.useRef)(null);
...
var DraggableLabel = import_react7.default.memo(({
  label,
  onUpdate,
  step,
  innerLabelTrim
  ...
  return import_react7.default.createElement(InnerNumberLabel, _extends2({
    dragging,
...
function Number$1({
  ...
  const InnerLabel2 = innerLabelTrim > 0 && import_react7.default.createElement(DraggableLabel, {
    label,
    step: settings.step,
    onUpdate,
    innerLabelTrim
  });
  return import_react7.default.createElement(NumberInput, {
    id,
...
function NumberComponent() {
  ...
  return import_react7.default.createElement(Row, {
    input: true
  }, import_react7.default.createElement(Label, null, label), import_react7.default.createElement(RangeGrid, {
    hasRange
  }, hasRange && import_react7.default.createElement(RangeSlider, _extends2({
    value: parseFloat(value),
    onDrag: onUpdate
  }, settings)), import_react7.default.createElement(Number$1, _extends2({}, props3, {
    id,
    label: "value",
...
function Select({
  ...
  const lastDisplayedValue = (0, import_react7.useRef)();
  if (value === values[displayValue]) {
    lastDisplayedValue.current = keys[displayValue];
  }
  return import_react7.default.createElement(SelectContainer, null, import_react7.default.createElement(NativeSelect, {
    id,
    value: displayValue,
    onChange: (e4) => onUpdate(values[Number(e4.currentTarget.value)]),
    disabled
  }, keys.map((key, index2) => import_react7.default.createElement("option", {
    key,
    value: index2
  }, key))), import_react7.default.createElement(PresentationalSelect, null, lastDisplayedValue.current), import_react7.default.createElement(Chevron, {
    toggled: true
  }));
}
function SelectComponent() {
  ...
  return import_react7.default.createElement(Row, {
    input: true
  }, import_react7.default.createElement(Label, null, label), import_react7.default.createElement(Select, {
    id,
    value,
    displayValue,
    onUpdate,
...
function String$1(_ref) {
  ...
  if (editable) return import_react7.default.createElement(ValueInput, _extends2({
    value: displayValue,
    onUpdate,
    onChange
  }, props3));
  return import_react7.default.createElement(NonEditableString, null, displayValue);
}
function StringComponent() {
  ...
  return import_react7.default.createElement(Row, {
    input: true
  }, import_react7.default.createElement(Label, null, label), import_react7.default.createElement(String$1, _extends2({
    displayValue,
    onUpdate,
    onChange
  }, settings)));
...
function Boolean2({
  ...
  return import_react7.default.createElement(StyledInputWrapper, null, import_react7.default.createElement("input", {
    id,
    type: "checkbox",
    checked: value,
...
function BooleanComponent() {
  ...
  return import_react7.default.createElement(Row, {
    input: true
  }, import_react7.default.createElement(Label, null, label), import_react7.default.createElement(Boolean2, {
    value,
    onUpdate,
    id,
    disabled
...
function Coordinate({
  ...
  const valueRef = (0, import_react7.useRef)(value[valueKey]);
  valueRef.current = value[valueKey];
  const setValue = (0, import_react7.useCallback)((newValue) => onUpdate({
  ...
  return import_react7.default.createElement(Number$1, {
    id,
    label: valueKey,
    value: value[valueKey],
...
function Lock(_ref) {
  ...
  return import_react7.default.createElement("svg", _extends2({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props3), locked ? import_react7.default.createElement("path", {
...
function Vector({
  ...
  return import_react7.default.createElement(Container, {
    withLock: lock
  }, lock && import_react7.default.createElement(Lock, {
    locked,
    onClick: () => setSettings({
      locked: !locked
    })
  }), Object.keys(value).map((key, i4) => import_react7.default.createElement(Coordinate, {
    id: i4 === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
function i3(e4) {
  var t4 = (0, import_react10.useRef)(e4), n4 = (0, import_react10.useRef)(function(e5) {
...
var m3 = import_react10.default.memo(function(o4) {
  var a4 = o4.onMove, l4 = o4.onKey, s4 = c3(o4, ["onMove", "onKey"]), m4 = (0, import_react10.useRef)(null), g4 = i3(a4), p4 = i3(l4), b4 = (0, import_react10.useRef)(null), _2 = (0, import_react10.useRef)(false), x3 = (0, import_react10.useMemo)(function() {
    var e4 = function(e5) {
  ...
  return (0, import_react10.useEffect)(function() {
    return H3;
  }, [H3]), import_react10.default.createElement("div", u3({}, s4, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m4, onKeyDown: E2, tabIndex: 0, role: "slider" }));
});
var g3 = function(e4) {
...
var p3 = function(r4) {
  ...
  return import_react10.default.createElement("div", { className: l4, style: { top: 100 * a4 + "%", left: 100 * n4 + "%" } }, import_react10.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t4 } }));
};
...
var S3 = import_react10.default.memo(function(r4) {
  var t4 = r4.hue, n4 = r4.onChange, o4 = g3(["react-colorful__hue", r4.className]);
  return import_react10.default.createElement("div", { className: o4 }, import_react10.default.createElement(m3, { onMove: function(e4) {
    n4({ h: 360 * e4.left });
  }, onKey: function(e4) {
    n4({ h: s3(t4 + 360 * e4.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b3(t4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react10.default.createElement(p3, { className: "react-colorful__hue-pointer", left: t4 / 360, color: q2({ h: t4, s: 100, v: 100, a: 1 }) })));
});
var T2 = import_react10.default.memo(function(r4) {
  var t4 = r4.hsva, n4 = r4.onChange, o4 = { backgroundColor: q2({ h: t4.h, s: 100, v: 100, a: 1 }) };
  return import_react10.default.createElement("div", { className: "react-colorful__saturation", style: o4 }, import_react10.default.createElement(m3, { onMove: function(e4) {
    n4({ s: 100 * e4.left, v: 100 - 100 * e4.top });
  }, onKey: function(e4) {
    n4({ s: s3(t4.s + 100 * e4.left, 0, 100), v: s3(t4.v - 100 * e4.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(t4.s) + "%, Brightness " + b3(t4.v) + "%" }, import_react10.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - t4.v / 100, left: t4.s / 100, color: q2(t4) })));
});
...
function Y2(e4, t4, l4) {
  var u4 = i3(l4), c4 = (0, import_react10.useState)(function() {
    return e4.toHsva(t4);
  }), s4 = c4[0], f4 = c4[1], v4 = (0, import_react10.useRef)({ color: t4, hsva: s4 });
  (0, import_react10.useEffect)(function() {
    if (!e4.equal(t4, v4.current.color)) {
      var r4 = e4.toHsva(t4);
      v4.current = { hsva: r4, color: t4 }, f4(r4);
    }
  }, [t4, e4]), (0, import_react10.useEffect)(function() {
    var r4;
    F2(s4, v4.current.hsva) || e4.equal(r4 = e4.fromHsva(s4), v4.current.color) || (v4.current = { hsva: s4, color: r4 }, u4(r4));
  }, [s4, e4, u4]);
  var d4 = (0, import_react10.useCallback)(function(e5) {
    f4(function(r4) {
...
var R2;
var V2 = "undefined" != typeof window ? import_react10.useLayoutEffect : import_react10.useEffect;
var $3 = function() {
...
var U2 = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react10.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react10.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react10.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react10.default.createElement(S3, { hue: d4.h, onChange: h4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  ...
  return import_react10.default.createElement("div", { className: l4 }, import_react10.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a4 }), import_react10.default.createElement(m3, { onMove: function(e4) {
    o4({ a: e4.left });
  }, onKey: function(e4) {
    o4({ a: s3(n4.a + e4.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u4 + "%", "aria-valuenow": u4, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react10.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: n4.a, color: k3(n4) })));
};
var re = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react10.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react10.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react10.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react10.default.createElement(S3, { hue: d4.h, onChange: h4 }), import_react10.default.createElement(ee, { hsva: d4, onChange: h4, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F2 };
var Ce = function(r4) {
  return import_react10.default.createElement(re, u3({}, r4, { colorModel: xe }));
};
...
var Ne = function(r4) {
  return import_react10.default.createElement(U2, u3({}, r4, { colorModel: Me }));
};
...
var Dropzone = (0, import_react11.forwardRef)(function(_ref, ref) {
  ...
  return import_react11.default.createElement(import_react11.Fragment, null, children(_objectSpread3(_objectSpread3({}, props3), {}, {
    open
  })));
});
...
function useDropzone() {
  ...
  var onFileDialogOpenCb = (0, import_react11.useMemo)(function() {
    return typeof onFileDialogOpen === "function" ? onFileDialogOpen : noop;
  }, [onFileDialogOpen]);
  var onFileDialogCancelCb = (0, import_react11.useMemo)(function() {
    return typeof onFileDialogCancel === "function" ? onFileDialogCancel : noop;
  }, [onFileDialogCancel]);
  var rootRef = (0, import_react11.useRef)(null);
  var inputRef = (0, import_react11.useRef)(null);
  var _useReducer = (0, import_react11.useReducer)(reducer, initialState), _useReducer2 = _slicedToArray2(_useReducer, 2), state = _useReducer2[0], dispatch = _useReducer2[1];
  var isFocused = state.isFocused, isFileDialogActive = state.isFileDialogActive, draggedFiles = state.draggedFiles;
  var fsAccessApiWorksRef = (0, import_react11.useRef)(typeof window !== "undefined" && window.isSecureContext && useFsAccessApi && canUseFileSystemAccessAPI());
  ...
  var dragTargetsRef = (0, import_react11.useRef)([]);
  ...
  var onDragEnterCb = (0, import_react11.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
  ...
  var onDragOverCb = (0, import_react11.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation(event);
  ...
  var onDragLeaveCb = (0, import_react11.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation(event);
  ...
  var setFiles = (0, import_react11.useCallback)(function(files, event) {
    var acceptedFiles = [];
    var fileRejections = [];
  ...
  var onDropCb = (0, import_react11.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation(event);
    dragTargetsRef.current = [];
  ...
  var openFileDialog = (0, import_react11.useCallback)(function() {
  ...
  var onKeyDownCb = (0, import_react11.useCallback)(function(event) {
  ...
  var onFocusCb = (0, import_react11.useCallback)(function() {
    dispatch({
      type: "focus"
    });
  }, []);
  var onBlurCb = (0, import_react11.useCallback)(function() {
    dispatch({
      type: "blur"
    });
  }, []);
  var onClickCb = (0, import_react11.useCallback)(function() {
    if (noClick) {
      return;
    }
    if (isIeOrEdge()) {
  ...
  var getRootProps = (0, import_react11.useMemo)(function() {
    return function() {
  ...
  var onInputElementClick = (0, import_react11.useCallback)(function(event) {
    event.stopPropagation();
  }, []);
  var getInputProps = (0, import_react11.useMemo)(function() {
    return function() {
...
function useDeepMemo(fn, deps) {
  return (0, import_react12.useMemo)(fn, useCompareMemoize(deps, true));
}
...
var useVisiblePaths = (store) => {
  const [paths, setPaths] = (0, import_react12.useState)(store.getVisiblePaths());
  (0, import_react12.useEffect)(() => {
...
function usePopin(margin = 3) {
  const popinRef = (0, import_react12.useRef)(null);
  const wrapperRef = (0, import_react12.useRef)(null);
  const [shown, setShow] = (0, import_react12.useState)(false);
  const show = (0, import_react12.useCallback)(() => setShow(true), []);
  const hide4 = (0, import_react12.useCallback)(() => setShow(false), []);
  (0, import_react12.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
...
function Color({
  ...
  const timer = (0, import_react12.useRef)(0);
  const [initialRgb, setInitialRgb] = (0, import_react12.useState)(() => convertToRgb(value, format3));
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, import_react12.default.createElement(ColorPreview, {
    ref: popinRef,
    active: shown,
    onClick: () => showPicker(),
    style: {
  ...
  }), shown && import_react12.default.createElement(Portal2, null, import_react12.default.createElement(Overlay, {
    onPointerUp: hidePicker
  }), import_react12.default.createElement(PickerWrapper, {
    ref: wrapperRef,
    onMouseEnter: () => window.clearTimeout(timer.current),
    onMouseLeave: (e4) => e4.buttons === 0 && hideAfterDelay()
  }, import_react12.default.createElement(ColorPicker, {
    color: initialRgb,
    onChange: onUpdate
  }))));
}
function ColorComponent() {
  ...
  return import_react12.default.createElement(Row, {
    input: true
  }, import_react12.default.createElement(Label, null, label), import_react12.default.createElement(PickerContainer, null, import_react12.default.createElement(Color, {
    value,
    displayValue,
    onChange,
    onUpdate,
    settings
  }), import_react12.default.createElement(ValueInput, {
    value: displayValue,
    onChange,
    onUpdate
  })));
...
function Vector3dComponent() {
  ...
  return import_react12.default.createElement(Row, {
    input: true
  }, import_react12.default.createElement(Label, null, label), import_react12.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  }));
...
function Joystick({
  ...
  const timeout = (0, import_react12.useRef)();
  const outOfBoundsX = (0, import_react12.useRef)(0);
  const outOfBoundsY = (0, import_react12.useRef)(0);
  const stepMultiplier = (0, import_react12.useRef)(1);
  const [joystickShown, setShowJoystick] = (0, import_react12.useState)(false);
  const [isOutOfBounds, setIsOutOfBounds] = (0, import_react12.useState)(false);
  const [spanRef, set] = useTransform();
  const joystickeRef = (0, import_react12.useRef)(null);
  const playgroundRef = (0, import_react12.useRef)(null);
  (0, import_react12.useLayoutEffect)(() => {
    if (joystickShown) {
      const {
        top,
  ...
  const startOutOfBounds = (0, import_react12.useCallback)(() => {
  ...
  const endOutOfBounds = (0, import_react12.useCallback)(() => {
  ...
  return import_react12.default.createElement(JoystickTrigger, _extends2({
    ref: joystickeRef
  }, bind()), joystickShown && import_react12.default.createElement(Portal2, null, import_react12.default.createElement(JoystickPlayground, {
    ref: playgroundRef,
    isOutOfBounds
  }, import_react12.default.createElement("div", null), import_react12.default.createElement("span", {
    ref: spanRef
  }))));
}
...
function Vector2dComponent() {
  ...
  return import_react12.default.createElement(Row, {
    input: true
  }, import_react12.default.createElement(Label, null, label), import_react12.default.createElement(Container$1, {
    withJoystick: !!settings.joystick
  }, settings.joystick && import_react12.default.createElement(Joystick, {
    value: displayValue,
    settings,
    onUpdate
  }), import_react12.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  })));
...
function ImageComponent() {
  ...
  const onDrop = (0, import_react12.useCallback)((acceptedFiles) => {
    if (acceptedFiles.length) onUpdate(acceptedFiles[0]);
  }, [onUpdate]);
  const clear = (0, import_react12.useCallback)((e4) => {
    e4.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
  ...
  return import_react12.default.createElement(Row, {
    input: true
  }, import_react12.default.createElement(Label, null, label), import_react12.default.createElement(ImageContainer, null, import_react12.default.createElement(ImagePreview, {
    ref: popinRef,
    hasImage: !!value,
  ...
  }), shown && !!value && import_react12.default.createElement(Portal2, null, import_react12.default.createElement(Overlay, {
    onPointerUp: hide4,
    style: {
      cursor: "pointer"
    }
  }), import_react12.default.createElement(ImageLargePreview, {
    ref: wrapperRef,
    style: {
      backgroundImage: `url(${value})`
    }
  })), import_react12.default.createElement(DropZone, getRootProps({
    isDragAccept
  }), import_react12.default.createElement("input", getInputProps()), import_react12.default.createElement(Instructions, null, isDragAccept ? "drop image" : "click or drop")), import_react12.default.createElement(Remove, {
    onClick: clear,
    disabled: !value
  })));
}
...
function IntervalSlider(_ref) {
  ...
  const minScrubberRef = (0, import_react12.useRef)(null);
  const maxScrubberRef = (0, import_react12.useRef)(null);
  const rangeWidth = (0, import_react12.useRef)(0);
  const scrubberWidth = useTh("sizes", "scrubberWidth");
  const bind = useDrag2(({
    event,
    first,
  ...
  return import_react12.default.createElement(RangeWrapper, _extends2({
    ref
  }, bind()), import_react12.default.createElement(Range, null, import_react12.default.createElement(Indicator, {
    style: {
      left: minStyle,
      right: maxStyle
    }
  })), import_react12.default.createElement(Scrubber, {
    position: "left",
    ref: minScrubberRef,
    style: {
      left: minStyle
...
function IntervalComponent() {
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, import_react12.default.createElement(Row, {
    input: true
  }, import_react12.default.createElement(Label, null, label), import_react12.default.createElement(Container2, null, import_react12.default.createElement(IntervalSlider, _extends2({
    value: displayValue
  }, settings, {
    onDrag: onUpdate
  })), import_react12.default.createElement(Vector, {
...
function useCreateStore() {
  return (0, import_react12.useMemo)(() => new Store(), []);
}
if (typeof window !== "undefined") {
...
function ControlInput(_ref) {
  ...
  return import_react12.default.createElement(InputContext.Provider, {
  ...
  }, import_react12.default.createElement(StyledInputWrapper$1, {
    disabled
  }, import_react12.default.createElement(Input, null)));
}
...
function Button({
  ...
  const store = useStoreContext();
  return import_react12.default.createElement(Row, null, import_react12.default.createElement(StyledButton, {
...
function ButtonGroup(props3) {
  ...
  return import_react12.default.createElement(Row, {
    input: !!label
  }, label && import_react12.default.createElement(Label, null, label), import_react12.default.createElement(StyledButtonGroup, null, Object.entries(opts).map(([label2, onClick]) => import_react12.default.createElement(StyledButtonGroupButton, {
    key: label2,
    onClick: () => onClick(store.get)
  }, label2))));
}
...
var MonitorCanvas = (0, import_react12.forwardRef)(function({
  initialValue
}, ref) {
  ...
  const [gradientTop, gradientBottom] = (0, import_react12.useMemo)(() => {
    return [w2(fillColor).alpha(0.4).toRgbString(), w2(fillColor).alpha(0.1).toRgbString()];
  }, [fillColor]);
  const points = (0, import_react12.useRef)([initialValue]);
  const min2 = (0, import_react12.useRef)(initialValue);
  const max2 = (0, import_react12.useRef)(initialValue);
  const raf = (0, import_react12.useRef)();
  const drawPlot = (0, import_react12.useCallback)((_canvas, _ctx) => {
    if (!_canvas) return;
    const {
      width,
      height
  ...
  (0, import_react12.useEffect)(() => () => cancelAnimationFrame(raf.current), []);
  return import_react12.default.createElement(Canvas, {
    ref: canvas
  });
});
var parse = (val) => Number.isFinite(val) ? val.toPrecision(2) : val.toString();
var MonitorLog = (0, import_react12.forwardRef)(function({
  initialValue
}, ref) {
  const [val, set] = (0, import_react12.useState)(parse(initialValue));
  (0, import_react12.useImperativeHandle)(ref, () => ({
    frame: (v4) => set(parse(v4))
  }), []);
  return import_react12.default.createElement("div", null, val);
});
...
function Monitor({
  ...
  const ref = (0, import_react12.useRef)();
  const initialValue = (0, import_react12.useRef)(getValue(objectOrFn));
  (0, import_react12.useEffect)(() => {
  ...
  return import_react12.default.createElement(Row, {
    ...
    align: "top"
  }, label), settings.graph ? import_react12.default.createElement(MonitorCanvas, {
    ref,
    initialValue: initialValue.current
  }) : import_react12.default.createElement(MonitorLog, {
    ref,
    initialValue: initialValue.current
  }));
}
...
var Control = import_react12.default.memo(({
  path
}) => {
  const [input, {
    set,
  ...
  if (type in SpecialInputs) {
    ...
    return import_react12.default.createElement(SpecialInputForType, _extends2({
      label,
      path
    }, inputProps));
  }
  ...
  return import_react12.default.createElement(ControlInput, _extends2({
    key: storeId + path,
    type,
    label,
    storeId,
...
function FolderTitle({
  ...
  return import_react12.default.createElement(StyledTitle, {
    onClick: () => toggle()
  }, import_react12.default.createElement(Chevron, {
    toggled
  }), import_react12.default.createElement("div", null, name));
}
var Folder = ({
  name,
  path,
  ...
  const [toggled, setToggle] = (0, import_react12.useState)(!collapsed);
  const folderRef = (0, import_react12.useRef)(null);
  ...
  return import_react12.default.createElement(StyledFolder, {
    ref: folderRef
  }, import_react12.default.createElement(FolderTitle, {
    name,
    toggled,
    toggle: () => setToggle((t4) => !t4)
  }), import_react12.default.createElement(TreeWrapper, {
    parent: newPath,
    tree,
    toggled
  }));
};
var TreeWrapper = import_react12.default.memo(({
  ...
  return import_react12.default.createElement(StyledWrapper, {
    ref: wrapperRef,
    isRoot: _isRoot,
    fill: _fill,
    flat: _flat
  }, import_react12.default.createElement(StyledContent, {
    ref: contentRef,
    isRoot: _isRoot,
    toggled
  }, entries.map(([key, value]) => isInput(value) ? import_react12.default.createElement(Control, {
    key: value.path,
    valueKey: value.valueKey,
    path: value.path
  }) : import_react12.default.createElement(Folder, {
    key,
    name: key,
    path: parent,
    tree: value
...
var FilterInput = import_react12.default.forwardRef(({
  setFilter,
  toggle
}, ref) => {
  const [value, set] = (0, import_react12.useState)("");
  const debouncedOnChange = (0, import_react12.useMemo)(() => debounce(setFilter, 250), [setFilter]);
  const clear = () => {
    setFilter("");
    set("");
  };
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, import_react12.default.createElement(StyledFilterInput, {
    ref,
    value,
...
function TitleWithFilter({
  ...
  const [filterShown, setShowFilter] = (0, import_react12.useState)(false);
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, import_react12.default.createElement(StyledTitleWithFilter, {
    ...
    width: 12,
    height: 8
  })), import_react12.default.createElement(TitleContainer, _extends2({}, drag ? bind() : {}, {
    drag,
    filterEnabled
  }), title === void 0 && drag ? import_react12.default.createElement("svg", {
    width: "20",
    height: "10",
    viewBox: "0 0 28 14",
    xmlns: "http://www.w3.org/2000/svg"
    ...
    cy: "12",
    r: "2"
  })) : title), filterEnabled && import_react12.default.createElement(Icon, {
    active: filterShown,
    ...
    clipRule: "evenodd"
  })))), import_react12.default.createElement(FilterWrapper, {
    toggled: filterShown
  }, import_react12.default.createElement(FilterInput, {
    ref: inputRef,
    setFilter,
    toggle
  })));
...
function LevaRoot(_ref) {
  ...
  const computedSetToggle = (0, import_react12.useMemo)(() => {
  ...
  return import_react12.default.createElement(ThemeContext.Provider, {
    value: themeContext
  }, import_react12.default.createElement(LevaCore, _extends2({
    store
  }, props3, {
...
var LevaCore = import_react12.default.memo(({
  store,
  rootClass,
  fill: _fill = false,
  flat: _flat = false,
  ...
  const tree = (0, import_react12.useMemo)(() => buildTree(paths, filter), [paths, filter]);
  ...
  globalStyles();
  return import_react12.default.createElement(PanelSettingsContext.Provider, {
    value: {
      hideCopyButton: _hideCopyButton
    }
  }, import_react12.default.createElement(StyledRoot, {
    ref: rootRef,
    className: rootClass,
    fill: _fill,
    flat: _flat,
  ...
  }, _titleBar && import_react12.default.createElement(TitleWithFilter, {
    onDrag: (point) => {
      set(point);
    ...
    filterEnabled,
    from: position
  }), shouldShow && import_react12.default.createElement(StoreContext.Provider, {
    value: store
  }, import_react12.default.createElement(TreeWrapper, {
    isRoot: true,
    fill: _fill,
...
function Leva(_ref) {
  ...
  return import_react12.default.createElement(LevaRoot, _extends2({
    store: levaStore
  }, props3));
}
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react12.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  const depsChanged = (0, import_react12.useRef)(false);
  const firstRender = (0, import_react12.useRef)(true);
  ...
  const [store] = (0, import_react12.useState)(() => (hookSettings === null || hookSettings === void 0 ? void 0 : hookSettings.store) || levaStore);
  const [initialData, mappedPaths] = (0, import_react12.useMemo)(() => store.getDataFromSchema(_schema), [store, _schema]);
  const [allPaths, renderPaths, onChangePaths, onEditStartPaths, onEditEndPaths] = (0, import_react12.useMemo)(() => {
    const allPaths2 = [];
    const renderPaths2 = [];
  ...
  const paths = (0, import_react12.useMemo)(() => store.orderPaths(allPaths), [allPaths, store]);
  const values = useValuesForPath(store, renderPaths, initialData);
  const set = (0, import_react12.useCallback)((values2) => {
    const _values = Object.entries(values2).reduce((acc, [p4, v4]) => Object.assign(acc, {
      [mappedPaths[p4].path]: v4
    }), {});
    store.set(_values, false);
  }, [store, mappedPaths]);
  const get = (0, import_react12.useCallback)((path) => store.get(mappedPaths[path].path), [store, mappedPaths]);
  (0, import_react12.useEffect)(() => {
